...
import { DrawerNavProps } from '../navigations/navigationTypes';
import { useTheme } from '@react-navigation/native';

interface HomeScreenProps {
}

const ABOUT = `# Dailymealz React Native Task #
...
const AboutScreen: React.FC<HomeScreenProps> = ({
    navigation
}: DrawerNavProps<'About'>) => {
    const { colors } = useTheme();

    return <SafeAreaView style={styles.container}>
        <ScrollView>
            <Text style={[styles.paragraph, {color: colors.text}]}>{ABOUT}</Text>
        </ScrollView>
    </SafeAreaView>
}
